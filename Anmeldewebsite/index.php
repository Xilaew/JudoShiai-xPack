    ...
    <div>
      ...
      <div>
        ...
        <form action="index.php" method="post" id="signUpForm" <?php echo( ($forceRegistration && getCoachId(false) == "") ? 'style="display: none;"' : ''); ?>>
          <div class="container">
            <div class="row">
              <div class="col-md form-group"><label for="input_firstName"><?php echo(_("First Name")); ?></label><input required name="firstName" id="input_fistName" type="text" class="form-control"></div>
            ...
            <div class="row">
              <div class="col-md form-group">
                ...
                <div class="input-group mb-3">
                  ...
                  <input name="yearOfBirth" id="input_yearOfBirth" type="number" required value="<?php echo(floor(($minYearOfBirth + $maxYearOfBirth) / 2)); ?>" class="form-control input-number–noSpinners">
                  <div class="input-group-append">
                    <button class="btn btn-outline-primary" type="button">+</button>
                  </div>            
                </div>
              </div>
              <div class="col-md form-group"><label for="btn_group_sex"><?php echo(_("Sex")); ?></label>
                <div id="btn_group_sex" class="btn-group d-flex btn-group-toggle" data-toggle="buttons">
                  <label for="input_male" class="btn btn-outline-primary w-100"><input id="input_male" required type="radio" name="sex" value="m"><?php echo(_("male")); ?></label>
                  <label for="input_female" class="btn btn-outline-primary w-100"><input id="input_female" required type="radio" name="sex" value="f"><?php echo(_("female")); ?></label>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md form-group"><label for="labelAgeCat"><?php echo(_("Age Category")); ?></label><div id="labelAgeCat"></div></div>
            ...
            <div class="form-group"><label for="input_club"><?php echo(_("Club")); ?> </label>
              <select name="club" required id="input_club" class="form-control" placeholder="<?php echo(_("Choose the competitor's club.")); ?>">
            ...
            <div class="form-group"><input name="register" type="submit" value="<?php echo(_('Register Competitor')); ?>" class="btn btn-primary"><span id="loading" style="display:none;"><p><img src="loading.gif" /><?php echo(_('please wait...')); ?></p></span></div>
          ...
          <div class="container">
            <div class="row"> 
              ...
              <div class="col-md form-group align-self-end">
                ...
                <input name="delCoachId" id="input_delCoachId" type="submit" value="<?php echo(_('Log-out')); ?>" <?php echo((getCoachId(false) == '') ? 'style="display:none;"' : ''); ?> class="btn btn-primary btn-blk">
                <span id="loading_coachId" style="display:none;"><p><img src="loading.gif" /><?php echo(_('please wait...')); ?></p></span>
              </div>
            </div>
          </div>
        </form>
